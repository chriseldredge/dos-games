...
#define  FIXREAL(n)  ((FLOTE)(((FLOTE)n)*65536))
...
BINT8    *wallptr;
FIXED     viewang, viewx, viewy,
          tan_table[ANGLE_360+1],
 ...
 for (ang=0;ang<ANGLE_360;ang++)
  {
   ...
   tan_table[ang]     = FIXREAL(tan(rad_angle));
   ...
   inv_cos_table[ang] = FIXREAL(1/cos(rad_angle));
   inv_sin_table[ang] = FIXREAL(1/sin(rad_angle));
  }
 ...
 for (ang=-ANGLE_30;ang<ANGLE_30;ang++)
  {
   ...
   cos_table[ang+ANGLE_30] = FIXREAL(13312/cos(rad_angle));
  }
